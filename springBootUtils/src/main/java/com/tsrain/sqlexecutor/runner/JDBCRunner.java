package com.tsrain.sqlexecutor.runner;

import com.alibaba.druid.pool.DruidDataSource;
import com.alibaba.druid.pool.DruidPooledConnection;
import com.tsrain.sqlexecutor.pojo.ResultSetHandler;
import com.tsrain.sqlexecutor.pool.DBManager;
import com.tsrain.sqlexecutor.utils.DataSourceUtils;
...
public class JDBCRunner {
     ...
     * @since 1.6
     */
    protected PreparedStatement prepareStatement(DruidPooledConnection conn, String sql, int returnedKeys) throws SQLException {
