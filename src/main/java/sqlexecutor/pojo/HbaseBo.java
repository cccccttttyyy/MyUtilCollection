...
public class HbaseBo extends Database {
	...
	private String kerberos_keytab_file_path;
	//创建时间
	...
	public String getKerberos_keytab_file_path() {
		return kerberos_keytab_file_path;
	}

	public void setKerberos_keytab_file_path(String kerberos_keytab_file_path) {
		this.kerberos_keytab_file_path = kerberos_keytab_file_path;
	}
	...
	public String toString() {
		return "HbaseBo [id=" + id + ", dbase_desc=" + dbase_desc + ", dbase_type=" + dbase_type + ", zk_quorum="
				...
				+ kerberos_enable + ", kerberos_principal=" + kerberos_principal + ", kerberos_keytab_file_path="
				+ kerberos_keytab_file_path + ", create_time=" + create_time + ", update_time=" + update_time
	...
	public int hashCode() {
		...
		result = prime * result + ((kerberos_keytab_file_path == null) ? 0 : kerberos_keytab_file_path.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (kerberos_enable != other.kerberos_enable)
			return false;
		if (kerberos_keytab_file_path == null) {
			if (other.kerberos_keytab_file_path != null)
				return false;
		} else if (!kerberos_keytab_file_path.equals(other.kerberos_keytab_file_path))
			return false;
