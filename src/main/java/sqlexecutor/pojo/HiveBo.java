...
public class HiveBo extends Database {
    ...
    public static HiveBo newInstance() {
        ...
        bo.setDbase_type(4);
        bo.setDbase_name("default");
        bo.setDbase_user("root");
        return bo;
    }
    ...
    public String toString() {
        return "HiveBo [id=" + id + ", dbase_desc=" + dbase_desc + ", dbase_type=" + dbase_type + ", dbase_ip="
                + dbase_ip + ", dbase_port=" + dbase_port + ", dbase_user=" + dbase_user + ", dbase_passwd="
                + dbase_passwd + ", dbase_name=" + dbase_name
